...
import { Upload, FileText, CheckCircle, AlertCircle, Clock, Shield, Coins } from "lucide-react"
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <BodyMD className="text-muted-foreground">
          Téléchargez votre facture pour commencer le processus de financement. Nous extrairons automatiquement les informations nécessaires.
        </BodyMD>
      </div>
          ...
          <div className="space-y-4 py-2">
            ...
            {uploading && (
              <div className="space-y-1">
                ...
                <div className="flex justify-between items-center">
                  <BodySM className="text-muted-foreground">Téléchargement en cours...</BodySM>
            ...
            {uploadComplete && (
              <div className="flex items-center gap-2 text-emerald-600">
                ...
                <BodySM className="font-medium">Facture téléchargée avec succès</BodySM>
              </div>
            )}
          </div>
        )}
