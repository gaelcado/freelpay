      ...
      <div className="flex flex-col gap-6 p-8 md:p-12">
        ...
        >
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className={typography('label', 'lg', 'text-primary font-semibold')}>
              FreelPay
            </span>
          </Link>
        </motion.div>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-md space-y-8">
            ...
            >
              <h1 className={typography('heading', 'xl', '!text-3xl md:!text-4xl lg:!text-5xl')}>
                Bienvenue
              </h1>
              <p className={typography('body', 'lg', 'text-muted-foreground mt-2')}>
